...
const file_common_v1_pagination_proto_rawDesc = "" +
	"\n" +
	"\x1acommon/v1/pagination.proto\x12\x13ecommerce.common.v1\"I\n" +
	"\vPageRequest\x12\x1b\n" +
	"\tpage_size\x18\x01 \x01(\rR\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\"6\n" +
	"\fPageResponse\x12&\n" +
	"\x0fnext_page_token\x18\x01 \x01(\tR\rnextPageTokenBTZRgithub.com/shrtyk/e-commerce-platform/internal/common/gen/proto/common/v1;commonv1b\x06proto3"
...
var file_common_v1_pagination_proto_goTypes = []any{
	(*PageRequest)(nil),  // 0: ecommerce.common.v1.PageRequest
	(*PageResponse)(nil), // 1: ecommerce.common.v1.PageResponse
}
