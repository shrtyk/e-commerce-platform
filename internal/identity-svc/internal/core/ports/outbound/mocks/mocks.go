...
func (_mock *MockSessionRepository) GetByID(ctx context.Context, sessionID uuid.UUID) (domain.Session, error) {
...
func (_c *MockSessionRepository_GetByID_Call) Run(run func(ctx context.Context, sessionID uuid.UUID)) *MockSessionRepository_GetByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockSessionRepository_GetByID_Call) RunAndReturn(run func(ctx context.Context, sessionID uuid.UUID) (domain.Session, error)) *MockSessionRepository_GetByID_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - sessionID uuid.UUID
//   - revokedAt time.Time
func (_e *MockSessionRepository_Expecter) Revoke(ctx interface{}, sessionID interface{}, revokedAt interface{}) *MockSessionRepository_Revoke_Call {
...
// IssueToken provides a mock function for the type MockTokenIssuer
func (_mock *MockTokenIssuer) IssueToken(user domain.User) (string, error) {
...
// MockTokenIssuer_IssueToken_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IssueToken'
type MockTokenIssuer_IssueToken_Call struct {
	*mock.Call
}

// IssueToken is a helper method to define mock.On call
//   - user domain.User
func (_e *MockTokenIssuer_Expecter) IssueToken(user interface{}) *MockTokenIssuer_IssueToken_Call {
	return &MockTokenIssuer_IssueToken_Call{Call: _e.mock.On("IssueToken", user)}
}

func (_c *MockTokenIssuer_IssueToken_Call) Run(run func(user domain.User)) *MockTokenIssuer_IssueToken_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockTokenIssuer_IssueToken_Call) Return(s string, err error) *MockTokenIssuer_IssueToken_Call {
	_c.Call.Return(s, err)
	return _c
}

func (_c *MockTokenIssuer_IssueToken_Call) RunAndReturn(run func(user domain.User) (string, error)) *MockTokenIssuer_IssueToken_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockUserRepository) GetByID(ctx context.Context, userID uuid.UUID) (domain.User, error) {
