...
type Querier interface {
	...
	DeleteStockReservationsByOrderID(ctx context.Context, orderID uuid.UUID) error
	...
	GetStockRecordByProductIDForUpdate(ctx context.Context, productID uuid.UUID) (StockRecord, error)
	ListProducts(ctx context.Context, arg ListProductsParams) ([]ListProductsRow, error)
	ListStockReservationsByOrderID(ctx context.Context, orderID uuid.UUID) ([]StockReservation, error)
